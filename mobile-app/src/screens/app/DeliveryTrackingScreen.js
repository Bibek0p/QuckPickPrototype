    ...
    try {
      ...
      switch (deliveryData.status) {
        ...
        case 'picked_up':
          ...
          break;
        case 'in_transit':
          setStatusText('Package in Transit');
          setDriverInfo(deliveryData.driver);
          break;
        case 'completed':
      ...
      <View style={styles.bottomPanel}>
        ...
        <View style={styles.statusContainer}>
          <View style={styles.statusIcon}>
            {deliveryStatus === 'requested' && <ActivityIndicator size="small" color="#4CAF50" />}
            {deliveryStatus === 'confirmed' && <Icon name="truck" size={24} color="#FF9800" />}
            {deliveryStatus === 'picked_up' && <Icon name="package-variant" size={24} color="#2196F3" />}
            {deliveryStatus === 'in_transit' && <Icon name="truck-fast" size={24} color="#9C27B0" />}
          ...
          <View style={styles.statusTextContainer}>
            ...
            <Text style={styles.statusSubtext}>
              {deliveryStatus === 'requested' && 'Finding available drivers for your package...'}
              {deliveryStatus === 'confirmed' && `${driverInfo?.name || 'Driver'} is on the way to pickup`}
              {deliveryStatus === 'picked_up' && 'Package has been picked up and is in transit'}
              {deliveryStatus === 'in_transit' && 'Your package is on its way to the destination'}
              {deliveryStatus === 'completed' && 'Package delivered successfully!'}
        ...
        <View style={styles.packageInfoContainer}>
          <View style={styles.packageDetails}>
            ...
            <View style={styles.packageInfo}>
              <Text style={styles.packageType}>{packageType || 'Package'}</Text>
              <Text style={styles.packageDescription}>
                Your package is being delivered safely
              </Text>
            </View>
          </View>
        </View>
            ...
            <View style={styles.driverDetails}>
              ...
              <View style={styles.driverInfo}>
                ...
                <Text style={styles.rating}>
                  ⭐ {driverInfo.rating || '4.8'} • {driverInfo.totalDeliveries || 0} deliveries
                </Text>
              </View>
            </View>
            <TouchableOpacity
